...
models = {
    "Random Forest Regressor": RandomForestRegressor(n_estimators=1000, min_samples_split=2, max_features=5,
                                                     max_depth=15, n_jobs=-1),
    "Gradient Boost Regressor": GradientBoostingRegressor(n_estimators= 200,
